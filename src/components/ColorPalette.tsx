...
import { Palette, ChevronDown, ChevronUp, Layers as LayerIcon, GripHorizontal } from 'lucide-react';
...
export const ColorPalette = () => {
    ...
    return (
        <div className="flex flex-col h-full border-t border-border bg-background">
            <div className="p-4 border-b flex items-center gap-2 font-medium bg-muted/30 text-sm">
                <Palette className="size-4" />
                Colors
                <span className="ml-auto text-xs text-muted-foreground">{solids.length + gradients.length}</span>
            </div>
